...
<form action="" method"post" class="sign-up__form" id="player-form">
    <div class="sign-up__header">
        ...
        <div class="sign-up__social-icons"><a href="" class="sign-up__social-icon sign-up__social-icon--facebook"><i
                    class='bx bxl-facebook-circle' style='color:#195df6'></i></a><a href=""
                class="sign-up__social-icon sign-up__social-icon--google"><i class='bx bxl-google'
                    style='color:#bfbfbf'></i></a></div>
    </div>
    <div class="sign-up__body">
        <div class="sign-up__input-group">
            <input required type="text" class="sign-up__input" placeholder="Nombres" id="name"
                name="name-input">
            <input required type="text" class="sign-up__input" placeholder="Apellidos" id="lastname"
                name="lastname-input">
        </div>
            <input required type="email" class="sign-up__input" placeholder="Correo Electrónico" id="email" name="email-input">
            <input required type="password" pattern=".{6,}" class="sign-up__input" placeholder="Contraseña" id="password" name="password-input">
            <input required type="password" class="sign-up__input"placeholder="Confirmar Contraseña" id="confirm-password"="confirm-password-input">
        <div class="sign-up__terms"><input required type="checkbox" id="acceptance" name="acceptance" class="sign-up__checkbox">
